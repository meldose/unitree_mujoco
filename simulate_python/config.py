...
DOMAIN_ID = 1 # Domain id (must match client)
INTERFACE = "eth0" # Interface (same machine or LAN)
...
HEADLESS = False # Run without MuJoCo viewer (useful on headless machines)
